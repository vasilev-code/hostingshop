                    ...
                    <main>
                        ...
                        <form action="{{ route('registration-form') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="password" placeholder="Логин" id="password" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="repeatPassword">Повторите пароль</label>
                                <input type="text" name ="repeatPassword" class="form-control" id="repeatPassword" placeholder="Повторите пароль">
                            </div>
                            <div class="form-group">
